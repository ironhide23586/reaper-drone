...
from utils.custom_controller import CustomController
...
class PegasusApp:
    ...
    def __init__(self):
        ...
        config_multirotor1.backends = [CustomController()]
        # print(Rotation.from_euler("XYZ", [0.0, 0.0, 0.0], degrees=True).as_quat())
